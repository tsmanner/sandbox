...
int main() {
  ...
  cout << "+---------+---------+---------+---------+---------+" << endl;
  cout << "| " << setw(7) << *x << " | " << setw(7) << *y << " | " << setw(7) << *z << " | " << setw(7) << xPyMz->resolve() << " | " << setw(7) << xyzMax->resolve() << " |" << endl; xv->getOperand().makeConcrete();
  cout << "| " << setw(7) << *x << " | " << setw(7) << *y << " | " << setw(7) << *z << " | " << setw(7) << xPyMz->resolve() << " | " << setw(7) << xyzMax->resolve() << " |" << endl; yv->getOperand().makeConcrete();
  cout << "| " << setw(7) << *x << " | " << setw(7) << *y << " | " << setw(7) << *z << " | " << setw(7) << xPyMz->resolve() << " | " << setw(7) << xyzMax->resolve() << " |" << endl; zv->getOperand().makeConcrete();
  cout << "| " << setw(7) << *x << " | " << setw(7) << *y << " | " << setw(7) << *z << " | " << setw(7) << xPyMz->resolve() << " | " << setw(7) << xyzMax->resolve() << " |" << endl;
  cout << "+---------+---------+---------+---------+---------+" << endl;
